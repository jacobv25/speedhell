...
- `player-shot-juice-2026-09-09.md` — research-viz: how the genre makes the basic shot feel powerful (boghog 101, Lazy Devs cart numbers, Vlambeer list, readability bounds) + six ranked pixel/frame recipes for the 320×427 field; viz at ~/Dev/claude-visualizations/2026-09-09-134344-shmup-player-shot-juice.html; feeds Q22 / feat/shot-look.
